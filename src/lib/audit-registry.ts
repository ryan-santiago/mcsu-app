...
export const AUDIT_MODULES = [
  ...
  { value: "employee_recommendations", label: "Employee Recommendation" },
  ...
  { value: "ta_applications", label: "Talent Acquisition — Applications" },
...
export const AUDIT_ACTIONS = [
  ...
  { value: "stage_moved", label: "Board stage moved" },
  { value: "scorecard_submitted", label: "Scorecard submitted" },
  { value: "team_approvers_updated", label: "Team approvers updated" },
  { value: "recommendation_created", label: "Recommendation created" },
  { value: "recommendation_updated", label: "Recommendation updated" },
  { value: "recommendation_submitted", label: "Recommendation submitted" },
  { value: "recommendation_step_approved", label: "Recommendation step approved" },
  { value: "recommendation_step_rejected", label: "Recommendation step rejected" },
  { value: "recommendation_cancelled", label: "Recommendation cancelled" },
  { value: "erf_generated", label: "ERF generated" },
